...
<div id="header" >
	...
	<div id="sidelist">
		...
		<div id="success">
			<h1>Feedback</h1>
			<a>Hello <?php if(@$_SESSION['user']==session_id()){
						
					$text = $_SESSION['username'];
					echo $text;
					} ?> Your response has been recorded.<br>We will Contact You Within 48hrs ;)<br>
					To go back To home Page Click <a href="../home.php">Here</a>  :)</a>
		</div>
