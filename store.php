...
<body>
  ...
  $('.directorySlider').directorySlider({
   animation: 'fade',
	...
	<div id="img" >
	<div id="main1">
			<h1>Welcome To --H.K.B.--</h1>
			<p> Welcome to the Most Cost-Effective,Heart Filling,Fooding Solution exclusively <br>
			<b>@</b> <b>Night Cafeteria H.K.B.</b></p>
		</div>
...
<a style="position:relative;left:650px;top:20px;font-weight:bold">Welcome User</a>		
	...
	<div id="menuBody" >
          ...
          <div class="menu sub">
			...
			<li data-cost="25" onclick="addCost(this)">Mushroom Matar  &#8377 25</li>
			<li data-cost="15" onclick="addCost(this)">Daal Fry  &#8377 15</li>
			<li data-cost="20" onclick="addCost(this)">Aloo Gobi  &#8377 25</li>
			<li data-cost="20" onclick="addCost(this)">Mixed Vegetable  &#8377 20</li>
			<li data-cost="25" onclick="addCost(this)">Veg Manchurian  &#8377 25</li>
			<li data-cost="25" onclick="addCost(this)">Paneer Manchurian  &#8377 25</li>
			<li data-cost="15" onclick="addCost(this)">Gobi Musallam  &#8377 15</li>
			<li data-cost="15" onclick="addCost(this)">Daal Fry  &#8377 15</li>
			<li data-cost="25" onclick="addCost(this)">Zofrani Pulao  &#8377 25</li>
			<li data-cost="15" onclick="addCost(this)">Amba Khatta  &#8377 15</li>
			<li data-cost="10" onclick="addCost(this)">Stuffed Masala Naan  &#8377 10</li>
			<li data-cost="8" onclick="addCost(this)">Missi Roti  &#8377 8</li>
			<li data-cost="5" onclick="addCost(this)">Roti &#8377 5</li>
        ...
        <div class="description row">
          ...
          <div class="menu sub">
            ...
            <ul class="menu">
            	...
            	<li data-cost="120" onclick="addCost(this)">Pepper Mutton  &#8377 120</li>
            	<li data-cost="120" onclick="addCost(this)">Mutton Roganjosh  &#8377 120</li>
        ...
        <div class="description row">
          ...
          <div class="menu sub">
            <ul class="menu">
          	...
          	<li data-cost="100" onclick="addCost(this)">Bloody Mary  &#8377 100</li>
	  ...
	  <div class="variety">
        ...
        <div class="description row">
          ...
          <div class="menu sub">
            <ul>
            	<li data-cost="15" onclick="addCost(this)">Pasta Salad  &#8377 15</li>
            		<li data-cost="25" onclick="addCost(this)">Russian Salad  &#8377 25</li>
            			<li data-cost="10" onclick="addCost(this)">Green Salad  &#8377 10</li>
            				<li data-cost="10" onclick="addCost(this)">Onion Salad  &#8377 10</li>
            					<li data-cost="15" onclick="addCost(this)">Sprouted Salad  &#8377 15</li>
            						<li data-cost="3" onclick="addCost(this)">Papad  &#8377 3</li>
			</ul>
			</div>
	...
	<div id="submitOrder">
		...
		<a style="width:20px">Total: </a><br>
		<input type=text id="sumcash" name="cash"></input>
	</div>
		<button id="submitButton" type="submit" style="top:80px">-Submit Order-</button>
